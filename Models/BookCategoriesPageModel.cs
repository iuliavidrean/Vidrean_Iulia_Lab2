...
namespace Vidrean_Iulia_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Vidrean_Iulia_Lab2Context context, Book book)
        {
            ...
            ViewData["Categories"] = AssignedCategoryDataList;
        }

        public void UpdateBookCategories(Vidrean_Iulia_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
